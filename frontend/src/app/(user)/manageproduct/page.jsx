...
const Manageproduct = () => {
            ...
            <div className='w-full md:w-1/3'>
                    <div className='flex justify-between items-center mb-6  px-10'>
                        <div class="w-[70%] bg-white p-6 shadow-xl rounded-lg">
                            ...
                            <h4 class="text-xl font-semibold mb-2">PRICE: {product.price}</h4>
                            <h4 class="text-xl font-semibold mb-2">CATEGORY: {product.category}</h4>
    ...
    const filterByCategory = (productList) => {
        ...
        const filteredProductList = filterProduct.filter(col => col.category.toLowerCase().includes(productList.toLowerCase()))
    ...
    return (
        <div className='p-10'>
           {/* <div className="text-center m-5"><input onChange={applysearch} type="text" />
           <button className="p-2 border border-black">search</button>
           </div>  */}
           <>
  {/* Hero */}
      ...
      <div className="text-center">
        ...
        <div className="mt-10 sm:mt-20">
          <button
            ...
            onClick={(e) => filterByCategory('cloth')}
          >
